    ...
    Context: XmtpSharedContext,
{
    ...
    /// mutable metadata extension as the base, then overlays any
    /// well-known component values stored in the OpenMLS AppData
    /// dictionary on top (no-op when the dictionary is empty).
